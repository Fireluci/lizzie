...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7016950483:AAG1StY7dAD3hoCE-2DshHYXiSCxxSVOMJs")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "1058015838 640617767 5051689666 6178075056").split()):
        ADMINS.append(int(x))
except ValueError:
